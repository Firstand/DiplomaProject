...
public class WxCardBaseInfo
{
    ...
    {
        setDateInfoTimeRange(beginTime.getTime() / 1000, (endTime.getTime()+432000000) / 1000);
    }
    ...
    public void setPayInfo() {
    	...
    	obj.put("swipe_card", new org.json.JSONObject());
    	m_data.put("pay_info", obj);
	}
    public org.json.JSONObject getPayInfo() {
    	return m_data.optJSONObject("pay_info").optJSONObject("swipe_card");
	}
    public void setIsSwipeCard(boolean is_swipe_card) {
    	getPayInfo().put("is_swipe_card", is_swipe_card);
	}
    public void setIsPayAndQrcode(boolean is_pay_and_qrcode) {
    	m_data.put("is_pay_and_qrcode", is_pay_and_qrcode);
	}
}
