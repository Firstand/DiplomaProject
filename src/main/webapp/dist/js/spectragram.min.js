if (typeof Object.create !== "function") {
	...
	var Instagram = {
		...
		initialize: function(options, elem) {
			this.elem = elem;
			this.$elem = $(elem);
			this.accessData = $.fn.spectragram.accessData, this.accessToken = this.accessData.accessToken, this.clientID =
				this.accessData.clientID, this.userCredentials = this.clientID + "&access_token=" + this.accessToken + "", this.options =
				$.extend({}, $.fn.spectragram.options, options);
			this.messages = {
		...
		display: function(results) {
			...
			if (results.data === undefined || results.meta.code !== 200 || results.data.length === 0) {
				...
				for (var i = 0; i < max; i++) {
					...
					imageCaption = results.data[i].caption !== null ? $("<span>").text(results.data[i].caption.text).html() : this.messages
						.defaultImageAltText;
					$image = $("<img>", {
						alt: imageCaption,
						attr: {
