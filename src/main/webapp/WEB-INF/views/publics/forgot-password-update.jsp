								...
								<div class="row">
									<div class="col-sm-12 col-xs-12">
										...
										<div class="mb-30">
											...
											<h6 class="text-center txt-grey nonecase-font">您通过了验证，请输入您的新密码。</h6>
										</div>	
										<div class="form-wrap">
											<form action="<%=basePath%>forgot_pwd.do" method="post" onsubmit="return check_forgot()">
												<input type="hidden" id="u_tel2" name="u_tel2" value="${u_tel }">
												...
												<div class="form-group text-center">
													<button type="submit" class="btn btn-info btn-rounded btn">确认修改</button>
												</div>
											</form>
										</div>
									</div>	
