...
<base href="<%=basePath%>">
	...
	<!-- Favicon -->
	<link rel="shortc0ut icon" href="favicon.ico">
...
<body>
										...
										<div class="streamline message-box nicescroll-bar">
											<a href="javascript:void(0)">
												<div class="sl-item unread-message">
													...
													<div class="sl-content">
														<span class="inline-block capitalize-font   pull-left message-per">1233Clay Masse</span>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default border-panel card-view pa-0">
							<div class="panel-wrapper collapse in">
								<div class="panel-body pa-0">
									<div class="chat-cmplt-wrap chat-for-widgets-1" id="chats_div">
										<div class="chat-box-wrap">
											<div>
												<form role="search" class="chat-search">
													<div class="input-group">
														<input id="example-input1-group21" name="example-input1-group2" class="form-control" placeholder="Search" type="text" oninput="onSearch()">
														<span class="input-group-btn">
														<button type="button" class="btn  btn-default"><i class="zmdi zmdi-search"></i></button>
														</span>
													</div>
														...
														<c:forEach items="${manager_not }" var="m_not" varStatus="num">
															<li class="chat-list">
																<div class="chat-body" id="user_first_${num.index }">
																	<a href="javascript:void(0)" onclick="chat_select(${m_not.manager_id },${m_not.manager_tel })">
																		<div class="chat-data">
																			<input type="hidden" id="manager" value="MANAGER_TABLE_room_">
																			<c:if test="${empty m_not.profileimg}">
																				<img class="user-img img-circle"  src="dist/img/user.png" alt="user"/>
																			</c:if>
																			<c:forEach items="${m_not.profileimg }" var="pf">
										...
										<div class="recent-chat-box-wrap">
											<div class="recent-chat-wrap">
												<div class="panel-heading ma-0 pt-15">
													<div class="goto-back" id="goto-back">
														...
														<input type="hidden" id="table_name_sender" name="table_name_sender" value="${table_name_sender }">
														<div id="u_nick1"><span class="inline-block txt-dark">&nbsp;</span></div>
														<a href="javascript:void(0)" class="inline-block text-right txt-grey"><i class="zmdi zmdi-more"></i></a>
														<div class="clearfix"></div>
													</div>
												</div>
												<div class="panel-wrapper collapse in" id="panel-body-chats-f">
													<div class="panel-body pa-0" id="panel-body-chats-c">
														<img alt="" src="dist/img/my_img/chats_index.png" class="img_my_chats" id = "img_my_chats_id">
													</div>
													<div class="panel-body pa-0">
														<div class="chat-content">
															<ul class="chatapp-chat-nicescroll-bar pt-20" id="chat-content-my1">
																
															</ul>
														</div>
													</div>
													<div id="we_chats1"></div>
												</div>
											</div>
										</div>
									</div>
						...
						<div class="panel panel-default card-view panel-refresh">
							...
							<div class="panel-heading">
								...
								<div class="pull-right">
									<a href="<%=basePath%>chats.do" class="pull-left inline-block refresh">
													...
													<div class="mail-option pl-15 pr-15">
														<div class="chk-all">
															<div class="checkbox checkbox-default inline-block">
																<input type="checkbox" id="checkbox051" onclick="checkbox_all()"/>
																<label for="checkbox051"></label>
																<span>全选</span>
															</div>
															<div class="checkbox checkbox-default inline-block">
																<a href="javascript:void(0)" class="checkbox-default" onclick="del()">
														...
														<ul class="unstyled inbox-pagination" name="barcon">
															<li><span>1-10 of </span><span id="span_length">0</span></li>
															<li>
																<a id="last" class="pl-15 pr-15" href="javascript:void(0)"><i class="fa fa-angle-left  pagination-left"></i></a>
															</li>
															<li>
																<a id="next" href="javascript:void(0)"><i class="fa fa-angle-right pagination-right"></i></a>
															</li>
														</ul>
													</div>
													<div class="table-responsive" style="overflow-x: hidden; overflow-y: hidden;">
														<table class="table table-inbox table-hover mb-0" id="idData">
															<tbody id="list_message_my"></tbody>
														</table>
													</div>
												</div>
											</aside>
	...
	<!-- ajax -->
	<script src="dist/videos/js_zy/chats_zy.js"></script>
