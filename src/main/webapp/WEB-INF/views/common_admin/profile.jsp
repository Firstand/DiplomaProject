...
<body>
				...
				<ul class="nav navbar-right top-nav pull-right">
					...
					<li class="dropdown auth-drp">
						...
						<ul class="dropdown-menu user-auth-dropdown" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
							<li>
								<a href="<%=basePath%>profile.do"><i class="zmdi zmdi-account"></i><span>个人信息</span></a>
							</li>
							<li>
									...
									<div class="profile-box">
										<div class="profile-cover-pic">
											<div class="fileupload btn btn-default">
												...
												<form action="" enctype="multipart/form-data" method="post"><input class="upload" type="file" id="upload_file1"></form>
											</div>
											<div class="profile-image-overlay">
												<c:if test="${empty manager.profileimg}">
													<img alt="背景" src="dist/img/mock1.jpg" style="width: 100%;height: 100%;object-fit:cover;" id="upload_file1_img">
												</c:if>
												<c:if test="${not empty manager.profileimg}">
													<c:set var="flag" value="0"></c:set>
													<c:forEach items="${manager.profileimg}" var="pf">
														<c:if test="${pf.pro_file_img_type==2}">
															<img alt="背景" src="/pro_backgroud/${pf.pro_file_img_path }" style="width: 100%;height: 100%;object-fit:cover;" id="upload_file1_img">
															<input type="hidden" value="${flag=1 }">
														</c:if>
													</c:forEach>
													<c:if test="${flag==0 }">
										...
										<div class="profile-info text-center">
											<div class="profile-img-wrap">
												<c:if test="${empty manager.profileimg}">
													<img class="inline-block mb-10" src="dist/img/mock1.jpg" alt="用户头像" id="upload_file2_img"/>
												</c:if>
												<c:if test="${not empty manager.profileimg}">
													<c:set var="flag" value="0"></c:set>
													<c:forEach items="${manager.profileimg}" var="pf">
														<c:if test="${pf.pro_file_img_type==1}">
															<img class="inline-block mb-10" src="/pro_head_portrait/${pf.pro_file_img_path }" alt="用户头像" id="upload_file2_img"/>
															<input type="hidden" value="${flag=1 }">
														</c:if>
													</c:forEach>
													<c:if test="${flag==0}">
												...
												<div class="fileupload btn btn-default">
													<span class="btn-text">edit</span>
													<form action="" enctype="multipart/form-data" method="post"><input class="upload" type="file" id="upload_file2"></form>
												</div>
											</div>	
											<h5 class="block mt-10 mb-5 weight-500 capitalize-font txt-primary">${manager.manager_name }</h5>
											<h6 class="block capitalize-font pb-20">店管家</h6>
										</div>
										<div class="social-info">
											<div class="row">
												<div class="col-xs-4 text-center">
													<span class="counts block head-font"><span class="counter-anim">345</span></span>
													<span class="counts-text block">今天收入</span>
												</div>
												<div class="col-xs-4 text-center">
													<span class="counts block head-font"><span class="counter-anim">246</span></span>
													<span class="counts-text block">交易笔数</span>
												</div>
												<div class="col-xs-4 text-center">
													<span class="counts block head-font"><span class="counter-anim">898</span></span>
													<span class="counts-text block">总收入</span>
												</div>
											</div>
											<button class="btn btn-primary btn-block  btn-anim mt-30" data-toggle="modal" data-target="#myModal"><i class="fa fa-pencil"></i><span class="btn-text">编辑个人信息</span></button>
											<div id="myModal" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
												<div class="modal-dialog">
													<div class="modal-content">
														<div class="modal-header">
															<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
															<h5 class="modal-title" id="myModalLabel">编辑个人信息</h5>
														</div>
																							...
																							<div class="form-body overflow-hide">
																								<div class="form-group">
																									...
																									<div class="input-group">
																										...
																										<input type="text" class="form-control" id="uname" name="uname" placeholder="willard bryant" readonly="readonly" value="${manager.manager_name }">
																									</div>
																								</div>
																								<div class="form-group">
																									<label class="control-label mb-10" for="exampleInputEmail_1">邮箱</label>
																									<div class="input-group">
																										<div class="input-group-addon"><i class="icon-envelope-open"></i></div>
																										<input type="email" class="form-control" id="email" name="email" placeholder="xyz@gmail.com" value="${manager.manager_email }">
																									</div>
																								</div>
																								<div class="form-group">
																									<label class="control-label mb-10" for="exampleInputContact_1">手机号</label>
																									<div class="input-group">
																										<div class="input-group-addon"><i class="icon-phone"></i></div>
																										<input type="email" class="form-control" id="phone" name="phone" placeholder="+102 9388333" >
																									</div>
																								</div>
																								<div class="form-group">
								...
								<div  class="panel-body pb-0">
									<div  class="tab-struct custom-tab-1">
										<ul role="tablist" class="nav nav-tabs nav-tabs-responsive" id="myTabs_8">
											<li class="active" role="presentation"><a  data-toggle="tab" id="profile_tab_8" role="tab" href="#profile_8" aria-expanded="false"><span>顾客反馈</span></a></li>
											<li  role="presentation" class="next"><a aria-expanded="true"  data-toggle="tab" role="tab" id="follo_tab_8" href="#follo_8"><span>会员<span class="inline-block">(246)</span></span></a></li>
											<li role="presentation" class=""><a  data-toggle="tab" id="photos_tab_8" role="tab" href="#photos_8" aria-expanded="false"><span>照片</span></a></li>
											<li role="presentation" class=""><a  data-toggle="tab" id="earning_tab_8" role="tab" href="#earnings_8" aria-expanded="false"><span>收益</span></a></li>
											<li role="presentation" class=""><a  data-toggle="tab" id="settings_tab_8" role="tab" href="#settings_8" aria-expanded="false"><span>设置个人信息</span></a></li>
											<li class="dropdown" role="presentation">
												<a  data-toggle="dropdown" class="dropdown-toggle" id="myTabDrop_7" href="#" aria-expanded="false"><span>更多</span> <span class="caret"></span></a>
				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
						<div class="panel panel-default border-panel card-view">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title pull-left">好友</h6>
								</div>
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body row pa-0">
									<div class="chat-cmplt-wrap chat-for-widgets" id="profile_div">
										<div class="chat-box-wrap">
											<div>
												<div class="users-nicescroll-bar">
													...
													<ul class="chat-list-wrap">
														<c:forEach items="${manager_not }" var="m_not">
														<li class="chat-list">
															<div class="chat-body">
																<a href="javascript:void(0)" onclick="chat_select(${m_not.manager_id },${m_not.manager_tel })">
																	<div class="chat-data">
										...
										<div class="recent-chat-box-wrap">
											<div class="recent-chat-wrap" id="index_div">
												...
												<div class="panel-wrapper collapse in">
													<div class="panel-body pa-0">
														<div class="chat-content">
															<ul class="users-chat-nicescroll-bar pt-20" id="chat-content-my">
	...
	$("#upload_file1").change(function(){
		...
		var f = document.getElementById("upload_file1").files[0];
		reads.readAsDataURL(f);
		reads.onload = function(){
		document.getElementById("upload_file1_img").src = this.result;
		}
		var fileM=document.querySelector("#upload_file1");
		//获取文件对象，files是文件选取控件的属性，存储的是文件选取控件选取的文件对象，类型是一个数组
	    var fileObj = fileM.files[0];
	    //创建formdata对象，formData用来存储表单的数据，表单数据时以键值对形式存储的。
	    var formData = new FormData();
	    formData.append('file', fileObj);
	    formData.append("flag","pro_backgroud");
		$.ajax({
	         type:"post",         //发送请求的方式，默认请求方式为get
	         url:"upload_img.do", //发送到什么位置
	...
	$("#upload_file2").change(function(){
		var reads = new FileReader();
		var f = document.getElementById("upload_file2").files[0];
		reads.readAsDataURL(f);
		reads.onload = function(){
		document.getElementById("upload_file2_img").src = this.result;
		document.getElementById("upload_file3_img").src = this.result;
		}
		var fileM=document.querySelector("#upload_file2");
		//获取文件对象，files是文件选取控件的属性，存储的是文件选取控件选取的文件对象，类型是一个数组
	    var fileObj = fileM.files[0];
	    //创建formdata对象，formData用来存储表单的数据，表单数据时以键值对形式存储的。
	    var formData = new FormData();
	    formData.append('file', fileObj);
	    formData.append("flag","pro_head_portrait");
		$.ajax({
	         type:"post",    	 //发送请求的方式，默认请求方式为get
	         url:"upload_img.do",//发送到什么位置
	         data:formData,      //要传给服务器的参数
