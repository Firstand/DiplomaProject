...
<body>
    ...
    <div class="wrapper  theme-1-active pimary-color-blue">
		...
		<div class="page-wrapper">
			<div class="container-fluid">
									...
									<div class="table-wrap">
										<div class="table-responsive">
											<table id="datable_1" class="table table-hover display  pb-30" >
												...
												<tbody>
													<c:forEach items="${array }" var="ar" varStatus="num">
														<tr>
															<td>${num.count }</td>
															<td>${ar.card_id }</td>
															<td>${ar.title }</td>
															<c:if test="${ar.state==1 }">
																<td>正常</td>
															</c:if>
															<c:if test="${ar.state==0 }">
																<td>已核销</td>
															</c:if>
															<td>${ar.creat_time }</td>
															<td>
																<input type="hidden" id="arr_${num.count }" value="${ar.show_qrcode_url }">
																<button onclick="viewCode(${num.count },${ar.state})" class="btn btn-default  btn-xs" data-toggle="modal" data-target="#myModal_putin"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">二维码</font></font></button>  
																<a href="deleteCard.do?cardid=${ar.card_id }" class="btn  btn-xs btn-danger"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">核销</font></font></a>
															</td>
														</tr>
													</c:forEach>
												</tbody>
				...
				<div id="myModal_putin" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body" id="img_div" align="center">
								<h5 class="mb-15">会员卡已失效，不能进行投放了！</h5>
							</div>
							<div class="modal-footer">
								<a style="display: none" id="print" class="btn btn-info dt-button buttons-print btn-primary" tabindex="0" aria-controls="example" href="javascript:void(0);" onclick="dayin()"><span>打印</span></a>
	...
	<script type="text/javascript">
		function viewCode(id,state) {
			if(state==1){
				var str = "<img alt='二维码' src='"+document.getElementById("arr_"+id).value+"'>";
				document.getElementById("img_div").innerHTML = str;
