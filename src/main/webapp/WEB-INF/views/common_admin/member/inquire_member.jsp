						...
						<div class="col-md-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">会员卡详细信息</h6>
									</div>
									<div class="clearfix"></div>
								</div>
								<div class="panel-wrapper collapse in">
													...
													<form class="form-horizontal" role="form">
														<div class="form-body">
															<div class="input-group col-md-4" style="float: right">
																<input type="number" id="code_id" name="code_id" class="form-control" placeholder="请输入您的卡号">
																<span class="input-group-btn">
																<button type="button" class="btn btn-primary" id="mySubmit"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
																</span>
															</div>
															<br/><br/>
															<h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-account mr-10"></i>个人信息</h6>
															<hr class="light-grey-hr"/>
															<!-- /Row -->
															<div class="row">
																<div class="col-md-6">
																	<div class="form-group">
																		...
																		<div class="col-md-9" id="headimgurl">
																		</div>
																	</div>
																</div>
																<!--/span-->
															...
															<div class="row">
																...
																<div class="col-md-6">
																	<div class="form-group">
																		...
																		<div class="col-md-9" id="nickname">
															...
															<div class="row">
																...
																<div class="col-md-6">
																	<div class="form-group">
																		<label class="control-label col-md-3">订阅时间:</label>
																		<div class="col-md-9" id="subscribe_time">
															...
															<h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-account-box mr-10"></i>地址</h6>
															<hr class="light-grey-hr"/>
															<div class="row">
																<div class="col-md-6">
																	<div class="form-group">
																		<label class="control-label col-md-3">国家:</label>
																		<div class="col-md-9" id="country">
															...
															<div class="row">
																<div class="col-md-6">
																	<div class="form-group">
																		...
																		<div class="col-md-9" id="province">
															...
															<div class="row">
																<div class="col-md-6">
																	<div class="form-group">
																		<label class="control-label col-md-3">订阅方式:</label>
																		<div class="col-md-9" id="subscribe_scene">
																...
																<div class="col-md-6">
																	<div class="form-group">
																		...
																		<div class="col-md-9" id="language">
					...
					$.ajax({
						...
						success:function(data){
							if(data.msg==-1){
								...
								swal("获取成功！", "获取会员信息成功！", "success");
								document.getElementById("headimgurl").innerHTML = "<img alt='头像' src='"+data.member.headimgurl+"'>"
								document.getElementById("openid").innerHTML = "<p class='form-control-static'>"+data.member.openid+"</p>";
								document.getElementById("nickname").innerHTML = "<p class='form-control-static'>"+data.member.nickname+"</p>";
								document.getElementById("sex").innerHTML = "<p class='form-control-static'>"+data.member.sex+"</p>";
								document.getElementById("subscribe_time").innerHTML = "<p class='form-control-static'>"+data.member.subscribe_time+"</p>";
								document.getElementById("country").innerHTML = "<p class='form-control-static'>"+data.member.country+"</p>";
								document.getElementById("province").innerHTML = "<p class='form-control-static'>"+data.member.province+"</p>";
								document.getElementById("city").innerHTML = "<p class='form-control-static'>"+data.member.city+"</p>";
								document.getElementById("subscribe_scene").innerHTML = "<p class='form-control-static'>"+data.member.subscribe_scene +"</p>";
								document.getElementById("language").innerHTML = "<p class='form-control-static'>"+data.member.language+"</p>";
							}
							else{
								swal("获取失败！", "查询会员信息失败，请核对您的卡号！", "error");
							}
						},
						dataType:"json"
					});
